...
const Game = {
  ...
  async showEasteregg() {
    ...
    const paragraphs = [
      '2026年暑假，我和舍友陈旭各自在不同的城市实习，相隔很远。',
      '我们偶尔会分享各自的感受。晚上九点走出写字楼，抬头看到白炽灯还亮着，拍一张照片发给他。他回我一张出租屋天花板的照片，说周末唯一的计划是“充电”。',
      '然后我们就开始想念学校。想念东湖的夜风、712的夜聊、珞珈山下漫无目的的散步、广八路里的烟火气，还有那些允许我们慢下来的时光。',
      '我们相信，在这个原本属于大学生的“暑假”里，有无数明年将要毕业的人，同我们一样。',
      '游戏的灵感来自旭哥的一篇小红书。他写了五个实习的结局。当我看到的时候，我觉得被击中了。',
      '我说，要不做成游戏吧。',
      '于是就有了你现在看到的这些。',
      '它是我们这个夏天一些情绪和感受的记录。如果你也正在经历——',
      '没关系的，慢慢来。'
    ];
